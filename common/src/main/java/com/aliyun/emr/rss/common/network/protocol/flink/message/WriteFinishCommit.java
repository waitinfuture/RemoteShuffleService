...
public final class WriteFinishCommit extends RequestMessage {
  public final String shuffleKey;
  // PartitionLocation.getUniqueId()
  public final String partUniqueId;

  public WriteFinishCommit(String shuffleKey, String partitionId) {
    this.shuffleKey = shuffleKey;
    this.partUniqueId = partitionId;
  }

  @Override
  public Type type() { return Type.WriteFinishCommit; }
  ...
  public static WriteFinishCommit decode(ByteBuf buf) {
    return new WriteFinishCommit(Encoders.Strings.decode(buf), Encoders.Strings.decode(buf));
  }
  ...
  public boolean equals(Object other) {
    if (other instanceof WriteFinishCommit) {
      WriteFinishCommit o = (WriteFinishCommit) other;
