...
package com.aliyun.rss.common.protocol;
...
public class RpcNameConstants {
  ...
  public static String RSS_LIFECYCLEMANAGER_EP = "RssLifecycleManagerEndpoint";
  public static String RSS_LIFECYCLEMANAGER_SYS = "RssLifecycleManagerSys";
