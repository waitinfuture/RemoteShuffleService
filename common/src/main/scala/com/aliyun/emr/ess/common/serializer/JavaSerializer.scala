...
package com.aliyun.emr.ess.common.serializer
...
import com.aliyun.emr.ess.common.util.{ByteBufferInputStream, ByteBufferOutputStream, Utils}

import scala.reflect.ClassTag

private[ess] class JavaSerializationStream(
...
private[ess] class JavaDeserializationStream(in: InputStream, loader: ClassLoader)
...
private[ess] class JavaSerializerInstance(
