 ...
 */
private[ess] case class RpcAddress(host: String, port: Int) {
...
private[ess] object RpcAddress {
  ...
  /** Returns the [[RpcAddress]] encoded in the form of "ess://host:port" */
  def fromEssURL(essUrl: String): RpcAddress = {
    val (host, port) = Utils.extractHostPortFromEssUrl(essUrl)
