...
import com.aliyun.emr.ess.common.rpc.{RpcAddress, RpcCallContext}
import com.aliyun.emr.network.client.RpcResponseCallback

private[ess] abstract class NettyRpcCallContext(override val senderAddress: RpcAddress)
 ...
 */
private[ess] class LocalNettyRpcCallContext(
 ...
 */
private[ess] class RemoteNettyRpcCallContext(
