 ...
 */
private[ess] trait RpcEnvFactory {
...
private[ess] trait RpcEndpoint {
  ...
  def receive: PartialFunction[Any, Unit] = {
    case _ => throw new EssException(self + " does not implement 'receive'")
  }
 ...
 */
private[ess] trait ThreadSafeRpcEndpoint extends RpcEndpoint
