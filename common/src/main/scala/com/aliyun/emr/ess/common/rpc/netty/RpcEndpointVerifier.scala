...
import com.aliyun.emr.ess.common.rpc.{RpcCallContext, RpcEndpoint, RpcEnv}
 ...
 */
private[ess] class RpcEndpointVerifier(override val rpcEnv: RpcEnv, dispatcher: Dispatcher)
  extends RpcEndpoint {
...
private[ess] object RpcEndpointVerifier {
