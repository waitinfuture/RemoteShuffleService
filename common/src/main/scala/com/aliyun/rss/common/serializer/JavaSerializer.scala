...
package com.aliyun.rss.common.serializer
...
import com.aliyun.rss.common.util.{ByteBufferInputStream, ByteBufferOutputStream, Utils}
...
private[rss] class JavaDeserializationStream(in: InputStream, loader: ClassLoader)
