...
import com.aliyun.rss.common.rpc.{RpcCallContext, RpcEndpoint, RpcEnv}
 ...
 */
private[rss] class RpcEndpointVerifier(override val rpcEnv: RpcEnv, dispatcher: Dispatcher)
  extends RpcEndpoint {
...
private[rss] object RpcEndpointVerifier {
