...
import com.aliyun.rss.common.util.{ThreadUtils, Utils}

/**
 * An exception thrown if RpcTimeout modifies a `TimeoutException`.
 */
private[rss] class RpcTimeoutException(message: String, cause: TimeoutException)
