...
package com.aliyun.rss.common.rpc
...
import com.aliyun.rss.common.rpc.netty.NettyRpcEnvFactory
import com.aliyun.rss.common.util.RpcUtils
...
abstract class RpcEnv(conf: RssConf) {
  ...
  private[rss] val defaultLookupTimeout = RpcUtils.lookupRpcTimeout(conf)
 ...
 */
private[rss] trait RpcEnvFileServer {
