...
public class EssShuffleWriter<K, V, C> extends ShuffleWriter<K, V> {
    ...
    private void close() throws IOException {
        ...
        essShuffleClient.mapperEnd(appId, shuffleId, (int) mapId, taskContext
        ...
        mapStatus = SparkUtils.createMapStatus(dummyId, mapStatusLengths, taskContext.taskAttemptId());
    }
    ...
    public Option<MapStatus> stop(boolean success) {
        try {
            ...
            essShuffleClient.cleanup(appId, shuffleId, (int) mapId, taskContext.attemptNumber());
        }
    }
}
