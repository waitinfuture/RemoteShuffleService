...
package com.aliyun.emr.jss.common.serializer
...
private[jss] class JavaSerializationStream(
...
private[jss] class JavaDeserializationStream(in: InputStream, loader: ClassLoader)
...
private[jss] class JavaSerializerInstance(
