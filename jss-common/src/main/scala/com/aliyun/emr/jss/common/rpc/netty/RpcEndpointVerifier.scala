...
import com.aliyun.emr.jss.common.rpc.{RpcCallContext, RpcEndpoint, RpcEnv}
 ...
 */
private[jss] class RpcEndpointVerifier(override val rpcEnv: RpcEnv, dispatcher: Dispatcher)
  extends RpcEndpoint {
...
private[jss] object RpcEndpointVerifier {
