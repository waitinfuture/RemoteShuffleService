 ...
 */
private[jss] class RpcTimeoutException(message: String, cause: TimeoutException)
 ...
 */
private[jss] class RpcTimeout(val duration: FiniteDuration, val timeoutProp: String)
