...
private[jss] case class OneWayOutboxMessage(content: ByteBuffer) extends OutboxMessage
  with Logging {
...
private[jss] case class RpcOutboxMessage(
    content: ByteBuffer,
...
private[jss] class Outbox(nettyEnv: NettyRpcEnv, val address: RpcAddress) {
