...
import com.aliyun.emr.ess.common.util.{IntParam, Utils}
...
class MasterArguments(args: Array[String], conf: EssConf) {
  ...
  if (System.getenv("ESS_MASTER_HOST") != null) {
    host = System.getenv("ESS_MASTER_HOST")
  }
  if (System.getenv("ESS_MASTER_PORT") != null) {
    port = System.getenv("ESS_MASTER_PORT").toInt
  }
